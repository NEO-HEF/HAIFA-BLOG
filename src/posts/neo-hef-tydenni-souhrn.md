...
Tenhle souhrn je postavený nad lokálním zrcadlem repozitáře `NEO_HEF` a nad výstupem `git log --all`. V dostupné historii je `313` commitů v intervalu `2026-03-12` až `2026-04-25`. Statistiky jsou nad všemi refy, takže zahrnují i merge commity a branchovou práci, ne jen čistý příběh větve `develop`.

## Rychlá čísla

- Rozsah historie: prvních `7` týdnů projektu
- Sledované období: `12. 03. 2026` až `25. 04. 2026`
- Nejaktivnější autoři: `Holý Petr (162)`, `Jan Krejčí (81)`, `Kupec Alexandr (37)`, `Bacovský Martin (24)`, `Michaela Žočková (7)`
...
| `Týden druhý` | `16. 03. 2026 - 22. 03. 2026` | 55 | systém se skládá do jednoho obrazu | [detail týdne]({{ '/posts/neo-hef-2026-w12/' | url }}) |
| `Týden třetí` | `23. 03. 2026 - 29. 03. 2026` | 18 | v dokumentaci se začíná dělat pořádek | [detail týdne]({{ '/posts/neo-hef-2026-w13/' | url }}) |
| `Týden čtvrtý` | `30. 03. 2026 - 05. 04. 2026` | 24 | z archivu vzniká migrační laboratoř | [detail týdne]({{ '/posts/neo-hef-2026-w14/' | url }}) |
| `Týden pátý` | `06. 04. 2026 - 12. 04. 2026` | 44 | přibývají hlubší rozbory a první PoC | [detail týdne]({{ '/posts/neo-hef-2026-w15/' | url }}) |
| `Týden šestý` | `13. 04. 2026 - 19. 04. 2026` | 46 | plán se mění v první spustitelné kroky | [detail týdne]({{ '/posts/neo-hef-2026-w16/' | url }}) |
| `Týden sedmý` | `20. 04. 2026 - 26. 04. 2026` | 100 | první implementační vlna nabírá tvar | [detail týdne]({{ '/posts/neo-hef-2026-w17/' | url }}) |

## Hlavní vývojová linka

NEO_HEF se zatím vyvíjí ve čtyřech jasných vlnách. Nejdřív import legacy zdrojů a referenčních stromů. Potom úklid a vybudování dokumentační a BMAD vrstvy. Následně detailnější code dissection, prompt engineering a tiskové PoCy. A nakonec přechod do první výrazné implementační vlny kolem `RZP`, `SPOL`, `SPK`, launcheru, přihlášení, auditu, zamykání a kompatibility kolem `fenCRep`.
